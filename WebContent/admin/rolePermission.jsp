		...
		jQuery(function($) {
			...
			$("#_submit").click(function(){
				if($('#_editForm').validate()){
					...
					$.post("${_path}/tscp?action=RolePermissionAction_save", $.extend($.formJson('_editForm'), {"isEnable" : true, 'permissionIds' : permissionIds}), function(d) {
						if(d){
							btn.button('reset');
							if(d.code == 1){
								$.aceRedirect("${_path}/tscp?action=RoleAction_role");
							}
							else {
